<template>
  <div
    v-if="!isDesktop"
    class="fixed bottom-0 left-0 right-0 z-10 h-[45px] w-full border-t border-t-[#e7e7e7] bg-white px-2.5 py-[5px]"
  >
    <div class="flex items-center justify-between h-full text-black">
